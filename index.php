...
<head>
    ...
    <style>
        :root { --tl-bg:#FAF8F6; --tl-pink:#E8305A; --tl-pink-dark:#B01F3F; --tl-muted:#888; --text-dark:#111; }
        body { margin:0; font-family: Arial, sans-serif; background: var(--tl-bg); color: var(--text-dark); }
        .hero-title { font-size:42px; font-weight:700; color:#111; letter-spacing:-1px; line-height:1.1; margin-bottom:14px; text-align:center; }
...
<body>
    <div class="strip-section">
        <h1 class="hero-title">Your fans <em>commission</em><br>your best work.</h1>
        <div class="creator-strip">
            <div class="strip-avatar-wrap">
                ...
                <button class="strip-avatar" id="stripAvatar" title="Choose a creator"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/></svg></button>
            </div>
            <input type="text" class="strip-input-field" id="topicInput" placeholder="Type your topic idea…" maxlength="100">
            <button class="strip-send" id="stripSend" disabled><svg width="14" height="14" viewBox="0 0 16 16" fill="none"><path d="M14 8L2 2l2 6-2 6 12-6z" fill="#fff"/></svg></button>
        </div>
...
const defaultAvatarSvg = `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/></svg>`;
